...
for plugin in all_plugins:
    ...
    if hasattr(imported_plugin, "plugin_help") and hasattr(imported_plugin, "plugin_name"):
        plugin_name = imported_plugin.plugin_name
        plugin_help = imported_plugin.plugin_help
        HELP.update({
            plugin: [{'name': plugin_name, 'help': plugin_help}]
        })


@Client.on_message(filters.command(["start","start@SamsungGeeksBot","help@SamsungGeeksBot", "help"]))
